...
public class HQ1 extends JFrame {
	JLabel lblNewLabel;
	...
	public HQ1() {
		...
		JRadioButton Option2 = new JRadioButton("753 BC");
		...
		Option2.setBounds(37, 137, 109, 23);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (Option2.isSelected()) {
					lblNewLabel_2.setText("Correct Answer!");
				}
				else {
					lblNewLabel_2.setText("Wrong Answer!");
				}
			}
		});
		...
		lblNewLabel_2.setBounds(203, 300, 148, 33);
